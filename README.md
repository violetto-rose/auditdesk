...
Run [AuditDesk.cmd](./AuditDesk.cmd). Choose the checks you want, press **Run selected audit**, then use **Export AI JSON** to save a compact structured report. Results are read-only: the app does not delete or alter anything.
